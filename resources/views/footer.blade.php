      ...
      <div class="container pt-5">
        <div class="row">
          <div class="col-12 col-md-4">
            <div class="pr-lg-5">
              <h1 class="heading h6 text-uppercase font-weight-700 mb-3"><strong>MyMart</strong> .</p>
            </div>
          </div>
        ...
        <div class="d-flex align-items-center">
          <span class="">
            &copy; 2020 <a href="https://webpixels.io/" class="footer-link" target="_blank">Aero2Aestro</a>. All rights reserved.
          </span>
